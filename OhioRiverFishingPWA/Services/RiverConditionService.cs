    ...
    public class RiverConditionService
    {
        ...
        public async Task<List<TargetFishRecommendation>> GetFishRecommendationsAsync()
        {
            ...
            return new List<TargetFishRecommendation>
            {
                ...
                new() { Species = "Flathead Catfish",       ActivityLevel = "Active",   PrimaryBait = "Large live or freshly-killed Bluegill, Sunfish, or creek Chubs",          TacticalRig = "Heavy Carolina Rig (4-6 oz sinker, 7/0-10/0 Circle Hook) on the bottom",     DepthStrategy = "Deep timber piles, undercut banks, bridge pilings at night",                ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/Pylodictis_olivaris.jpg/800px-Pylodictis_olivaris.jpg" },
                ...
                new() { Species = "Walleye",                ActivityLevel = "Moderate", PrimaryBait = "Live minnows, nightcrawlers on harness, or 4\" paddle-tail swimbait",     TacticalRig = "Bottom Bouncer with Worm Harness or 3/8 oz Jig tipped with minnow",          DepthStrategy = "Rocky structure, gravel humps, current breaks (12-30 ft)",                  ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Sander_vitreus.jpg/800px-Sander_vitreus.jpg" },
